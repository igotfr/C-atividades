...
Crie um programa que lê um número natural n do teclado e imprime todos os divisores desse
número. Ao final, imprima também a soma dos divisores encontrados.
